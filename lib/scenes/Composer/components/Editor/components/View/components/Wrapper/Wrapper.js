...
function (_super) {
  ...
  Wrapper.prototype.render = function () {
    ...
    var compProps = {};
    var navigations = this.props.context.readProperty('navigations'); // tslint:disable-next-line:no-console
    ...
    var languages = this.props.context.readProperty('languages');
    ...
    return React.createElement("div", {
      ...
      id: editor
    })) : null), React.createElement(RenderErrorCatcher, null, React.createElement(Comp, __assign({
